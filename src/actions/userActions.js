import {
  ...
  USER_FOLLOW_RESET,
  USER_UNFOLLOW_RESET,
  USER_FOLLOW_LIST_RESET,
  USER_UNFOLLOW_LIST_RESET,
  USER_SEARCH_RESET,
  USER_SEARCH_RELATIVE_RESET,
  USER_MAIL_SIGNUP_RESET,
  USER_LIST_LOAD_MORE_RESET,
} from "../constants/userConstants";
import {
  ARTICLE_LIST_RESET,
  ARTICLE_LIST_LOAD_MORE_RESET,
  ARTICLE_YOUR_LIST_RESET,
  ARTICLE_LIST_FAVORITE_RESET,
  ARTICLE_LIST_FEED_RESET,
  ARTICLE_CREATE_RESET,
  ARTICLE_UPDATE_RESET,
  ARTICLE_DETAILS_RESET,
  ARTICLE_POPULAR_RESET,
  ARTICLE_FAVORITE_RESET,
  ARTICLE_UNFAVORITE_RESET,
  ARTICLE_RELATIVE_TAG_RESET,
  ARTICLE_RELATIVE_AUTHOR_RESET,
  ARTICLE_DELETE_RESET,
  ARTICLE_NEW_LIST_RESET,
  ARTICLE_SEARCH_RESET,
  ARTICLE_SEARCH_RELATIVE_RESET,
} from "../constants/articleConstants";
import {
  COMMENT_CREATE_RESET,
  COMMENT_DELETE_RESET,
  COMMENT_LIST_RESET,
  COMMENT_LIST_LOAD_MORE_RESET,
} from "../constants/commentConstants";
import {
  TAG_LIST_RESET,
  TAG_SEARCH_RESET,
  TAG_SEARCH_RELATIVE_RESET,
  TAG_LIST_LOAD_MORE_RESET,
...
export const logout = () => (dispatch) => {
  ...
  dispatch({ type: USER_FOLLOW_LIST_RESET });
  dispatch({ type: USER_UNFOLLOW_LIST_RESET });
  dispatch({ type: USER_SEARCH_RESET });
  dispatch({ type: USER_SEARCH_RELATIVE_RESET });
  dispatch({ type: USER_MAIL_SIGNUP_RESET });
  dispatch({ type: USER_LIST_LOAD_MORE_RESET });
  dispatch({ type: TAG_LIST_RESET });
  dispatch({ type: TAG_SEARCH_RESET });
  dispatch({ type: TAG_SEARCH_RELATIVE_RESET });
  dispatch({ type: TAG_LIST_LOAD_MORE_RESET });
  dispatch({ type: COMMENT_CREATE_RESET });
  dispatch({ type: COMMENT_DELETE_RESET });
  dispatch({ type: COMMENT_LIST_RESET });
  dispatch({ type: COMMENT_LIST_LOAD_MORE_RESET });
  dispatch({ type: ARTICLE_LIST_RESET });
  dispatch({ type: ARTICLE_LIST_LOAD_MORE_RESET });
  dispatch({ type: ARTICLE_YOUR_LIST_RESET });
  dispatch({ type: ARTICLE_LIST_FAVORITE_RESET });
  dispatch({ type: ARTICLE_LIST_FEED_RESET });
  dispatch({ type: ARTICLE_CREATE_RESET });
  dispatch({ type: ARTICLE_UPDATE_RESET });
  dispatch({ type: ARTICLE_DETAILS_RESET });
  dispatch({ type: ARTICLE_POPULAR_RESET });
  dispatch({ type: ARTICLE_FAVORITE_RESET });
  dispatch({ type: ARTICLE_UNFAVORITE_RESET });
  dispatch({ type: ARTICLE_RELATIVE_TAG_RESET });
  dispatch({ type: ARTICLE_RELATIVE_AUTHOR_RESET });
  dispatch({ type: ARTICLE_DELETE_RESET });
  dispatch({ type: ARTICLE_NEW_LIST_RESET });
  dispatch({ type: ARTICLE_SEARCH_RESET });
  dispatch({ type: ARTICLE_SEARCH_RELATIVE_RESET });
};
...
export const getFollowListUser =
  (username, token, offset, limit = 10) =>
  async (dispatch) => {
    try {
