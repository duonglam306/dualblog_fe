...
const ArticleScreen = () => {
  ...
  const editorComment = useRef(null);
  const configReply = useMemo(
    () => ({
      style: {
        font: "0.8em Arial",
      },
  ...
  const editorReply = useRef(null);

  const commentListLoadMore = useSelector((state) => state.commentListLoadMore);
          ...
          {userInfo && (
            <div
              ...
              <div className="user-info d-flex align-items-center">
                ...
                />
                <div className="font-text username">{userInfo.username}</div>
              </div>
              <div className="mt-2">
                <JoditEditor
                  tabIndex={1}
            ...
            <div className="comment-list mt-3">
              {comments && total > 0 ? (
                          ...
                          <div className="author d-flex justify-content-between px-2 py-1">
                            ...
                            {userInfo &&
                              (userInfo.username === cmt.auth_name ||
                                userInfo.username === article.auth_name) && (
                                <div
                        ...
                        <div
                          ...
                          <div className="card rounded-0 border-0">
                            <div className="reply-list ms-3 ps-3 border-start border-2">
                              {cmt.replyContentList.map((reply) => {
                                return (
                                  <div key={reply._id}>
                                    <CommentInfo
                                      cmt={reply}
                                      slug={slug}
                                      article_auth_name={article.auth_name}
                                    />
                                  </div>
                                );
                              })}
                ...
                <div className="empty-comment font-text d-flex align-items-center text-center justify-content-center">
                  <i>
                    There are currently no responses for this story. <br />
                    ...
                    <div className="mt-3">
                      <div className="information me-auto">
                        <Link
                          ...
                          <div className="bio font-text">{profile.bio}</div>
                        </Link>
                      </div>
