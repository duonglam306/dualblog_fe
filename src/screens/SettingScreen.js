                ...
                <div>
                  ...
                  <div className="col-12 d-flex mt-4">
                    <div className="col-9 info info-image">
                      <div className="title fw-bold">Photo</div>
                      <div className="d-flex">
                        <form className="col-9" noValidate>
                          {editImage ? (
                            <div>
                              <input
                                className={`body p-0 col-12 border-0 border-bottom ${
                                  validImage ? "" : "is-invalid"
                                }`}
                                id="inputPhoto"
                                value={image}
                                required
                          ...
                          <div className="description mt-3">
                            ...
                            <div>
                              Recommended: use url of image, size square. File
                              type: JPG, PNG or GIF.
                            </div>
                          </div>
                        </form>
                        ...
                        <>
                          <div className="me-2">
                            <button
                              ...
                              onClick={(e) => updateHandler(e, "image")}>
                              Save
                            </button>
                          </div>
                          <div>
                  ...
                  <div className="col-12 d-flex mt-4">
                    <div className="col-9 info info-name">
                      <div className="title fw-bold">Username</div>
                      <div className="d-flex">
                        <form className="col-9" noValidate>
                          {editUsername ? (
                            <div>
                              ...
                              />
                              <div className="invalid-feedback">
                                Username must have length from 8 to 25
                                characters.
                              </div>
                            </div>
                          ) : (
                        ...
                        <>
                          <div className="me-2">
                            {validUsername ? (
                              <button
                                className="border-success text-success rounded-pill"
                                onClick={(e) => updateHandler(e, "username")}>
                                Save
                              </button>
                            ) : (
                              <button
                  ...
                  <div className="col-12 d-flex mt-4">
                    <div className="col-9 info info-email">
                      <div className="title fw-bold">Email</div>
                      <div className="d-flex">
                        <div className="col-9">
                          <input
                  ...
                  <div className="col-12 d-flex mt-4">
                    <div className="col-9 info info-bio">
                      <div className="title fw-bold">Bio</div>
                      <div className="d-flex">
                        <form className="col-9" noValidate>
                          {editBio ? (
                            <div>
                              ...
                              />
                              <div className="invalid-feedback">
                                Maximum length of bio is 160 characters.
                              </div>
                            </div>
                          ) : (
                            <input
                  ...
                  <div className="col-12 d-flex mt-4">
                    <div className="col-9 info info-password">
                      <div className="title fw-bold">Password</div>
                      <div className="d-flex">
                        <div className="col-9">
                          {editPassword && (
                            <form noValidate>
                              ...
                              <input
                                className={` body form-control p-0 col-12 border-0 border-bottom ${
                                  validConfirmPassword ? "" : "is-invalid"
                                }`}
                        ...
                        <>
                          <div className="me-2">
                            {validPassword && validConfirmPassword ? (
                              <button
                                className="border-success text-success rounded-pill"
                                onClick={(e) => updateHandler(e, "password")}>
                                Save
                              </button>
                            ) : (
                              <button
