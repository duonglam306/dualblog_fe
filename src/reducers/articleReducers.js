...
export const articleListLoadMoreReducer = (
  ...
  switch (action.type) {
    ...
    case ARTICLE_LIST_LOAD_MORE_FAIL:
      return { loading: false, error: action.payload };
    case ARTICLE_LIST_LOAD_MORE_RESET:
      return {};
    default:
      return state;
  }
...
export const articleSearchRelativeReducer = (
  ...
  switch (action.type) {
    ...
    case ARTICLE_SEARCH_RELATIVE_FAIL:
      return { loading: false, error: action.payload };
    case ARTICLE_SEARCH_RELATIVE_RESET:
      return {};
    default:
      return state;
  }
...
export const articleRelativeTagReducer = (
  ...
  switch (action.type) {
    ...
    case ARTICLE_RELATIVE_TAG_FAIL:
      return { loading: false, error: action.payload };
    case ARTICLE_RELATIVE_TAG_RESET:
      return {};
    default:
      return state;
  }
...
export const articleRelativeAuthorReducer = (
  ...
  switch (action.type) {
    ...
    case ARTICLE_RELATIVE_AUTHOR_FAIL:
      return { loading: false, error: action.payload };
    case ARTICLE_RELATIVE_AUTHOR_RESET:
      return {};
    default:
      return state;
  }
...
export const articleFavoriteListReducer = (
  ...
  switch (action.type) {
    ...
    case ARTICLE_LIST_FAVORITE_FAIL:
      return { loading: false, error: action.payload };
    case ARTICLE_LIST_FAVORITE_RESET:
      return {};
    default:
      return state;
  }
